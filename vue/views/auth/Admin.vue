<template>
    <div>
        <div class="bg-blue-400 h-screen w-screen" v-if="!isLogin">
            <div class="flex flex-col items-center flex-1 h-full justify-center px-4 sm:px-0">
                <div class="flex rounded-lg shadow-lg w-full sm:w-3/4 lg:w-1/2 bg-white sm:mx-0" style="height: 500px">
                            ...
                            <div class="w-full mt-4">
                                <form class="form-horizontal w-3/4 mx-auto" method="POST" action="#">
                                    <div class="flex flex-col mt-4">
                                        <el-input v-model="form.mobile" placeholder="请输入手机号" size="normal"
                                                  clearable></el-input>
                                        <hd-error name="mobile"/>
                                    </div>
                                    <div class="flex flex-col mt-4">
                                        <el-input v-model="form.password" placeholder="请输入登录密码" size="normal" clearable
                    ...
                    <div
                        ...
                        style="
                            background: url('https://images.unsplash.com/photo-1513436751219-68cb8861ebef?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=634&q=80');
